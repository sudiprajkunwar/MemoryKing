...
//     console.log(idx, "sx");
//     setIsFlip(true);
//     setOpenedCard((prev: any) => [...prev, idx]);
//   };
//   useEffect(() => {
//     if (openedCard.includes(idx)) setIsFlip(true);
//   }, [idx, openedCard]);

//   useEffect(() => {
//     if (matched.includes(data.id)) setIsFlip(true);
//   }, [matched, data]);

//   return (
//     <Container className="visible" onClick={() => handleCardClick(idx)}>
//       <StyledBackFace
//         className="card-face"
//         style={{
